...
final class QueryBuilderTest extends TestCase
{
    ...
    public function testSimpleQueryWithoutAlias()
    {
        $q = $this->getBuilder()->from("users")->toSQL();
        $this->assertEquals("SELECT * FROM users", $q);
    }
    ...
    public function testSelectMultiple()
    {
        $q = $this->getBuilder()
            ...
            ->select('product')
            ->select('city');
        $this->assertEquals("SELECT id, name, product, city FROM users", $q->toSQL());
    }
